...
export const projectData = [
...

    {
        ...
        techStack: ["React", "Chart.js", "Bootstrap CSS", "Semantic UI", "Babel", "Webpack"],
    ...
    },
    {
        ...
        techStack: ["React", "React Leaflet", "CSS", "Babel", "Webpack", "OSM", "NPM"],
        link: "https://www.npmjs.com/package/travel-itinerary",
    },

    {
        title: "Field Management System",
        description: "Complex field management system where user add their fields , drones , pesticides where the drone captured images are shown in the field alongside marking the infected part of the plant",
        techStack: ["React", "Hero UI", "Tailwind CSS", "Redux Toolkit", "React Query"]
    },
    {
        title: "Yours Humanly Nepal Admin System",
        description: "A admin system for Yours Humanly Nepal where the admin can modify their whole data for user side frontend.",
        link: "https://yourshumanlynepal.org.np/",
        techStack: ["React", "Chakra UI", "React Query", "Tailwind CSS", "Redux Toolkit"],
    }
];
